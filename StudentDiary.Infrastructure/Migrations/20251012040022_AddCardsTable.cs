        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttackPower = table.Column<int>(type: "INTEGER", nullable: true),
                    DefensePower = table.Column<int>(type: "INTEGER", nullable: true),
                    Element = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
